private ["_lootTable","_index","_itemType","_crate","_config","_itemTypes","_weights","_cntWeights","_num","_amount"];

crate_add_loot = {
	private ["_iItem","_iClass","_itemTypes","_index","_weights","_cntWeights","_qty","_max","_tQty","_canType","_mags","_amount","_crate"];
