...
if (MAI_debugLevel > 1) then {diag_log format["MAI Extended Debug: AI killed by player at %1. Generating loot with weapongrade %2.",mapGridPosition _unit,_weapongrade];};
