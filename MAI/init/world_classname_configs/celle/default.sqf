...
//Remove classnames
MAI_militaryTypes = MAI_militaryTypes - ["Camo1_DZ","Sniper1_DZ","Bandit1_DZ"];
MAI_Backpacks0 = MAI_Backpacks0 - ["DZ_Czech_Vest_Puch"];
MAI_Backpacks1 = MAI_Backpacks1 - ["DZ_Czech_Vest_Puch"];
...
for "_i" from 0 to ((count _newItems) - 1) do {MAI_militaryTypes set [(count MAI_militaryTypes),(_newItems select _i)];};
...
for "_i" from 0 to ((count _newItems) - 1) do {MAI_Edibles set [(count MAI_Edibles),(_newItems select _i)];};
