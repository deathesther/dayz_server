...
if ((MAI_maxHeliPatrols > 0) or (MAI_maxLandPatrols > 0) or MAI_dynAISpawns) then {
	"MAI_centerMarker" setMarkerPos [7652.9634, 7870.8076];
...
if (MAI_staticAI) then {
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,175,thisTrigger,['CastleRog','CastleRog2','Rog3','Rog4'],1] call fnc_spawnmilitary;", "0 = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_134 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,200,thisTrigger,['DevilsCastle','DevilsCastle2','Devils3','Devils4'],1] call fnc_spawnmilitary;", "0 = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_138 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [2,2,175,thisTrigger,['CastleZub','CastleZub2','Zub3','Zub4'],1] call fnc_spawnmilitary;", "0 = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_140 = _this;
