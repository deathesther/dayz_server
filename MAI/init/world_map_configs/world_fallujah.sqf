...
if (MAI_dynAISpawns) then {
	"MAI_centerMarker" setMarkerPos [5139.8008, 4092.6797];
...
if (MAI_staticAI) then {
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,250,thisTrigger,[],3] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_5 = _this;
