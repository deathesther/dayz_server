/*
	MAI Custom Spawn Function
	
	Description: An easy-to-use function for server admins to create AI spawns at specific locations.
	
 
	
	Explanation of MAI_spawn:
	
	[
		"MAIcustomspawntest",	//This is the marker name to be used as the patrol and spawning area.
		...
		true					//(OPTIONAL) Respawn setting. True: AI spawned will respawn. False: AI will not respawn. See more here: http://opendayz.net/threads/release-MAI-lite-dynamic-ai-package.11116/page-28#post-79148
	] call MAI_spawn;
