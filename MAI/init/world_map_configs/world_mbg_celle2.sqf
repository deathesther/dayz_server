...
if (MAI_staticAI) then {
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,175,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_9 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,100,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_23 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,125,thisTrigger,[],2,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_25 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,0,125,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_31 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,2,125,thisTrigger,[],3] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_41 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,150,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_69 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,150,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_73 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,180,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_89 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,0,125,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_95 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,125,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_103 = _this;
	...
	_this setTriggerTimeout [10, 15, 20, true];
	_this setTriggerText "Fassberg Barracks";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,2,300,thisTrigger,['ETHS1','ETHS2','ETHS3','ETHS4'],3] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_118 = _this;
	//end triggers
};
