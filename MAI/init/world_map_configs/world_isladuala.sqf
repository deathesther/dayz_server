...
if (MAI_staticAI) then {
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,200,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_4 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,250,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_12 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,200,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_14 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,175,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_16 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,0,200,thisTrigger,[],2,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_20 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,175,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_38 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,250,thisTrigger,[],2,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_40 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,150,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_48 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,200,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_50 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,125,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_54 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,250,thisTrigger,[],2,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_58 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,250,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_60 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,200,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_80 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,250,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_84 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,250,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_88 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,125,thisTrigger,[],0,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_90 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,125,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_94 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,200,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_114 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,0,225,thisTrigger,[],1,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_146 = _this;
