...
if (MAI_dynAISpawns) then {
	"MAI_centerMarker" setMarkerPos [5166.5581, 5108.8301];
	"MAI_centerMarker" setMarkerSize [4500, 4500];
	if (isNil "MAI_dynTriggersMax") then {MAI_dynTriggersMax = 11;};
};
...
if (MAI_staticAI) then {
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,175,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_0 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,200,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_2 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,175,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_4 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,225,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_8 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,150,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_10 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,125,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_12 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,150,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_14 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,250,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_16 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,200,thisTrigger,['Sargento1','Sargento2','Sargento3','Sargento4','Sargento5'],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_20 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,150,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_22 = _this;
	...
	_this setTriggerActivation ["ANY", "PRESENT", true];
	_this setTriggerTimeout [10, 15, 20, true];
	_this setTriggerText "MAI Trigger";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,150,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_26 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,140,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_28 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,175,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_32 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,150,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_44 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,175,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_46 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,175,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_48 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,150,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_50 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,185,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_52 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,185,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_60 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,225,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_72 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,200,thisTrigger,[],0] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_74 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,225,thisTrigger,[],2,2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_78 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,225,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_88 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,2,200,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_92 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,200,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_94 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,200,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_100 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,200,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_102 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,0,150,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_104 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,150,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_114 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,175,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_120 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,225,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_122 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,150,thisTrigger,['Prison1','Prison2','Prison3','Prison4','Prison5'],3] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_124 = _this;
	...
	_this setTriggerTimeout [10, 15, 20, true];
	_this setTriggerText "MAI Trigger";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,175,thisTrigger,[],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_126 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,140,thisTrigger,[],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_130 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,100,thisTrigger,['Palace1','Palace2','Palace3'],2] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
	_trigger_138 = _this;
	...
	if ((MAI_modName == "lingorskaro") || (MAI_modName == "huntinggrounds")) then {
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,175,thisTrigger,['NMB1_1','NMB1_2','NMB1_3','NMB1_4','NMB1_5'],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
		_trigger_168 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,175,thisTrigger,['NMB2_1','NMB2_2','NMB2_3','NMB2_4','NMB2_5'],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
		_trigger_171 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,165,thisTrigger,['NMB3_1','NMB3_2','NMB3_3','NMB3_4','NMB3_5'],1] call fnc_spawnmilitary;", "nul = [thisTrigger] spawn fnc_despawnmilitary;"];
		_trigger_177 = _this;
