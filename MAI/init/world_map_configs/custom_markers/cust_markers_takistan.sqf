/*
	...
	Example Marker (Note: the marker name must be unique! In this example, it's named "MAIcustomspawntest"):
	
	_this = createMarker ["MAIcustomspawntest", [6650.9883, 9411.541, -6.1035156e-005]];
	_this setMarkerShape "ELLIPSE";
	_this setMarkerType "Flag";
	_this setMarkerBrush "Solid";
	_this setMarkerSize [200, 200];
	_this setMarkerAlpha 0;
	_MAIcustomspawntest = _this;		//_MAIcustomspawntest must be a unique name
