...
DZAI_randDynTriggers = {
	#include "\z\addons\dayz_server\DZAI\compile\fn_randomizeTriggers.sqf"
};
...
//DZAI group side assignment function. Detects when East side has too many groups, then switches to east side.
DZAI_getFreeSide = {
	private["_groupSide"];
	_groupSide = east;
...
DZAI_unitDeath = {
	...
	[_victim,_killer,_unitGroup] call DZAI_AI_killed_all;
