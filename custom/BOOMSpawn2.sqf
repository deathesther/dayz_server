...
_this = createMarker ["bandit_main_base_S2", [1125.2408, 2504.8452, 4.754096]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
sleep 1;
	["bandit_main_base_S6",3,2,False] call DZAI_spawn;

_this = createMarker ["bandit_main_base_S7", [1268.3259, 2482.1604, 12.253339]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
sleep 1;
	["bandit_main_base_S7",3,2,False] call DZAI_spawn;

_this = createMarker ["bandit_main_base_S8", [1173.8083, 2443.1899, 0.22979879]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
sleep 1;
	["bandit_main_base_S8",3,2,False] call DZAI_spawn;

_this = createMarker ["bandit_main_base_S9", [1210.1614, 2389.3882, 6.3649211]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
sleep 1;
	["bandit_main_base_S9",3,2,False] call DZAI_spawn;

_this = createMarker ["bandit_main_base_S10", [1151.1241, 2374.2646, 10.744423]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
sleep 1;
	["bandit_main_base_S10",3,2,False] call DZAI_spawn;
