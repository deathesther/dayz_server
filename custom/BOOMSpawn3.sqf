...
_this setMarkerSize [120, 120];
_this setMarkerAlpha 0;
bandit_main_base_E1 = _this;
sleep 1;
	["bandit_main_base_E1",8,2,False] call DZAI_spawn;
...
sleep 1;
	["bandit_main_base_E6",6,2,False] call DZAI_spawn;

_this = createMarker ["bandit_main_base_E7", [13325.62, 2748.0781, 0]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
...
_this = createMarker ["bandit_main_base_E11", [12449.68, 3341.6812, 0]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
